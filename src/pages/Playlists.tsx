  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground mt-1">Escolha uma playlist para o seu ambiente.</p>
      </div>
      ...
      {isLoading ? (
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {playlists.map((pl) => (
            ...
            >
              <div className="h-32 rounded-lg bg-muted mb-3 flex items-center justify-center overflow-hidden">
                {pl.cover_image_url ? (
