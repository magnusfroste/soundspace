  ...
  public: {
    Tables: {
      ...
      schedule_entry_announcements: {
        ...
        Relationships: [
          {
            foreignKeyName: "schedule_entry_announcements_announcement_id_fkey"
          ...
          {
            foreignKeyName: "schedule_entry_announcements_schedule_entry_id_fkey"
